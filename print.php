                ...
                <div class="row">
                    <div class="left floated left aligned six wide column">
                        <div class="ui">
                            ...
                            <h1 class="ui header pageTitle">Invoice <small class="ui sub header">With Credit</small>
                            </h1>
                    ...
                    <div class="right floated left aligned four wide column">
                        <div class="ui">
                            <div>
                                <img class="logo" height="100px" width="100px" src="IMG/logo.png" style="position: absolute; right: 20px;" />
                                <!-- <ul class="">
...
?>
                    ...
                    <table class="ui celled table">
                        ...
                        <tfoot class="full-width">
                            <tr>
                                ...
                                ?>
                                <th colspan="1"><?php echo $row['tt']; ?> </th>
                                <?php
            ...
            <div class="ui card">
                ...
                <div class="content">
                    Payment is requested within 90 days of recieving this invoice.
                </div>
            </div>
