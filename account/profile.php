                                            ...
                                            ?>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-10">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['address']; ?>" name="address" required>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-10">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['mobile_no']; ?>" name="mobilenumber" required>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-10">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['contact']; ?>" name="contact" required>
