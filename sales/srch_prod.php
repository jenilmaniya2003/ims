                                                        ...
                                                        ?>
                                                            <form method="post" action="srch_prod.php?action=add&pid=<?php echo $row["id"]; ?>">
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" class="product-quantity" name="ProductPrice" value="<?php echo $row['price']; ?>" size="3" /></td>
                                                                    <td>
                                    ...
                                    <div class="row">
                                        <div class="col-sm">
                                            <div class="table-wrap">
                                                ...
                                                <a id="btnEmpty" href="srch_prod2.php?action=empty">Empty Cart</a>
                                                <?php
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="srch_prod2.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="../IMG/delete.png" height="20px" width="20px" alt="Remove Item" /></a>
                                                                    </td>
                                                                </tr>
                                                            <?php
